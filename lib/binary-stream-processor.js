...
class BinaryStreamProcessor {
  ...
  //   let invalidPacketsPerSecond = this.invalidPacketCount / ((Date.now() - this.startTime) / 1000);
  //   process.stdout.clearLine();  // clear current text
  //   process.stdout.cursorTo(0);  // move cursor to beginning of line
  //   process.stdout.write('packets/sec: ' + packetsPerSecond.toFixed() + 
  //   ', invalid packets/sec: ' + invalidPacketsPerSecond.toFixed() + 
