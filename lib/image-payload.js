...
class ImagePayload {
  ...
  parse(sequenceFlag, data) {
    if( sequenceFlag === 1 || sequenceFlag === 3 ) {
      ...
      this.DATA = data.substr(0, data.length-(4*2));
    }
  }
