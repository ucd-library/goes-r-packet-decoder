...
class SpacePacket {
  ...
  finalize() {
    ...
    if( this.validCrc ) {
      ...
      // console.log(this.packet.PRIMARY_HEADER_PARSED);
      // console.log(this.packet.SECONDARY_HEADER_PARSED);
      // console.log(crc, this.packet.CRC.toString('hex').replace(/^0+/,''), this.packet.DATA.length);
